...
if (isset($_POST ['register_btn'])) {
    ...
    if ($password == $password2) {
        //create user
        //$password = md5($password); //hash password before storing for security purposes - har udkommenteret fordi dette ikke fungerer. Hash ville gøre at password ikke var tilgængeligt for alle
